...
stareal
    .controller("ModifyBindingController", function ($scope, $api, $stateParams, $alert, $document, localStorageService, $state, $interval) {
        $scope.telphone_no = "";
        $scope.accessToken = "";
        ...
        $scope.login = {
            ...
            save:function (){
                ...
                localStorageService.set("rebind_code",$scope.code)
                localStorageService.set("rebind_tel",$scope.telphone_no)
